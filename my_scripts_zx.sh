...
# rotated_reppoints
python tools/train.py "./configs/rotated_reppoints/rotated_reppoints_r50_fpn_1x_dota_le135.py" --work-dir "D:/zqc2/1-code/mmrotate_dir/rotated_reppoints_r50_fpn_1x_dota_le135/20230223"
